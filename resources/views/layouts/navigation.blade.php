...
<nav x-data="{ open: false, showLogin: false }" class="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100 shadow-sm">
        ...
        <div class="flex justify-between items-center h-20 gap-4">
            ...
            <div class="flex items-center gap-10 flex-shrink-0">
                ...
                <div class="hidden sm:flex items-center space-x-8 text-base">
                    <a href="{{ url('/#regions-pagodas') }}" class="text-gray-900 hover:text-orange-500 transition duration-150 ease-in-out font-extrabold decoration-none whitespace-nowrap">
                    ...
                    <a href="{{ url('/#contact') }}" class="text-gray-900 hover:text-orange-500 transition duration-150 ease-in-out font-extrabold decoration-none whitespace-nowrap">
                        ဆက်သွယ်ရန်
                    </a>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end flex-grow gap-4 min-w-0">
                ...
                <div class="flex items-center justify-end flex-grow max-w-[1000px]">
                    <form action="#" method="GET" id="searchForm" class="m-0 w-0 opacity-0 overflow-hidden transition-all duration-300 ease-in-out flex items-center w-full justify-end">
                        <div class="flex items-center w-full min-w-[200px] sm:min-w-[320px] md:max-w-[540px] lg:max-w-[1000px] bg-white rounded-full px-6 py-3 border-2 border-orange-500 focus-within:border-orange-600 focus-within:ring-2 focus-within:ring-orange-600 shadow-sm">
                    ...
                    <button type="button" id="searchBtn" class="p-2 text-gray-600 hover:text-orange-500 hover:bg-gray-50 rounded-full transition duration-150 focus:outline-none flex-shrink-0">
                ...
                <div class="hidden sm:flex sm:items-center flex-shrink-0">
                    ...
                    @else
                        {{-- Login Button --}}
                        <a href="#" @click.prevent="showLogin = true" class="p-1.5 text-gray-600 hover:text-orange-500 hover:bg-gray-50 rounded-full transition duration-150 focus:outline-none inline-flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-7 w-7 text-orange-500">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-gray-50 border-t border-gray-200 max-h-[calc(100vh-80px)] overflow-y-auto">
        <div class="pt-2 pb-3 space-y-1 px-4">
            <a href="{{ url('/#regions-pagodas') }}" @click="open = false" class="block pl-3 pr-4 py-2.5 border-l-4 border-transparent text-base font-extrabold text-gray-900 hover:bg-gray-100 hover:border-orange-500 hover:text-orange-500 decoration-none">တိုင်းဒေသကြီး/ပြည်နယ်ရှိဘုရားများ</a>
            <a href="{{ url('/#famous-pagodas') }}" @click="open = false" class="block pl-3 pr-4 py-2.5 border-l-4 border-transparent text-base font-extrabold text-gray-900 hover:bg-gray-100 hover:border-orange-500 hover:text-orange-500 decoration-none">တန်ခိုးကြီးဘုရားများ</a>
            <a href="{{ url('/#contact') }}" @click="open = false" class="block pl-3 pr-4 py-2.5 border-l-4 border-transparent text-base font-extrabold text-gray-900 hover:bg-gray-100 hover:border-orange-500 hover:text-orange-500 decoration-none">ဆက်သွယ်ရန်</a>
            
            @guest
                <a href="#" @click.prevent="showLogin = true; open = false" class="block pl-3 pr-4 py-2.5 border-l-4 border-transparent text-base font-extrabold text-orange-600 hover:bg-orange-50 hover:border-orange-500 decoration-none">အကောင့်ဝင်ရန် (Login)</a>
            @endguest
        </div>
    </div>
        ...
        >
            ...
            <div class="p-8 sm:p-10">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <button @click="showLogin = false" class="text-gray-400 hover:text-gray-600 hover:bg-gray-100 p-2 rounded-full focus:outline-none transition duration-150">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="mb-5">
                        <label for="modal_email" class="block text-sm font-black text-gray-700 mb-4 pl-1">အီးမေးလ်လိပ်စာ</label>
                        <input 
                            id="modal_email" 
                            type="email" 
                            name="email" 
                    ...
                    <div class="mb-5">
                        <label for="modal_password" class="block text-sm font-black text-gray-700 mb-4 pl-1">လျှို့ဝှက်နံပါတ်</label>
                        <input 
                            id="modal_password" 
                            type="password" 
                            name="password" 
                    ...
                    <div class="flex items-center justify-between pt-1">
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="remember" class="rounded border-gray-300 text-orange-500 shadow-sm focus:ring-orange-500 h-4 w-4">
                            <span class="ms-2.5 text-xs font-bold text-gray-500 select-none">မှတ်ထားရန်</span>
                        </label>

                        @if (Route::has('password.request'))
                            <a class="text-xs font-bold text-orange-500 hover:text-orange-600 transition decoration-none" href="{{ route('password.request') }}">
                    ...
                    <div class="pt-4">
                        <button type="submit" class="w-full text-white font-black py-4 px-4 text-base shadow-lg transition duration-150 focus:outline-none active:scale-[0.99]"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function closeSearchBox() {
            searchForm.classList.remove('w-full', 'md:max-w-[540px]', 'lg:max-w-[720px]', 'opacity-100', 'mr-2');
